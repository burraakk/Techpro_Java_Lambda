...
public class C04_ExplicitNarrowing {
    public static void main(String[] args) {
        ...
        System.out.println("sayi2: " +sayi2);//50//burada sikinti yok

        int sayi3 = 500;
        byte sayi4 = (byte) sayi3;
        System.out.println("sayi4: "+sayi4);//-12//veri baskalasti

        double sayi5 = 45.341;
        int sayi6 = (int) sayi5;
        System.out.println("sayi6: "+sayi6);//45//veri kaybi olur
