...
public class C03_NestedIfElse {
    public static void main(String[] args) {
        /*
        emeklilik kontrolu yapan bir program yaz
        cinsiyet olarak E(erkek) veya K(kadin) degiskenlerini kabul etsin
        farkli bir harf veya sembol girerse hata mesaji versin

        emeklilik için kadinlarda yas siniri 60
        erkeklerdce 65 olsun

        negatif veya 80'den buyuk bi yas girerse hata mesaji versin
         */
