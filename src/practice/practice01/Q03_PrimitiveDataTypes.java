...
public class Q03_PrimitiveDataTypes {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("intMin = " + intMin); //burada yazdirirken soutv kullaniyoruz..degeriyle beraber yazdirir
        ...
        float laptopFiyat = 9500.99f;
        double kilometre = 35.55;
        char seviye = 'A';
        boolean dogruMu = true;

        System.out.println("Laptop fiyati : "+laptopFiyat);
        System.out.println("Gidilen kilometre : "+kilometre);
        System.out.println("Dil Seviyesi : "+seviye);
        System.out.println("Bu dogru mu : "+dogruMu);
