...
public class C04_OverLoading {
    public static void main(String[] args) {
        ...
        topla(5.2,3);//8.2
        topla(3.4, 6.1);//9.5
        topla(3,5.2);// double double olan metod calisir.. autowideninig yapar
        /*
        ...
        en az  cas yaparak kullanabilecegi method'u tercih eder
         */
    }
    ...
    /*
    Bir class'da parametre sayisi ve parametre data turleri ayni olan 2 method OLUSTURULAMAZ
