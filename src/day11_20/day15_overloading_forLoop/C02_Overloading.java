...
public class C02_Overloading {
    public static void main(String[] args) {
        ...
        mesela bir String'in bir bolumunu almak icin Java 2 adet substring() methodu,
         Verilen Stringteki bazi parcalari yenileriyle degistirmek icin 2 adet replace()methodu var..
