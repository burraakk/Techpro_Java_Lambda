...
public class C02_Child implements I01_InterfaceBodyOlanMethod{
    ...
    public static void main(String[] args) {
        ...
        I01_InterfaceBodyOlanMethod.direksiyon(); //7static keyword kullanilirsa InterfaceAdi.methodAdi

        C02_Child obj = new C02_Child();
        obj.teker();                //default keyword kullanilirsa method'a erismek icin obje olusturulmalidir.
